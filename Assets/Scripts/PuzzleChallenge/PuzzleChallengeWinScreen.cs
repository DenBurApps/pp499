...
public class PuzzleChallengeWinScreen : MonoBehaviour
{
    ...
    {
        if (PlayerPrefs.HasKey("PuzzleChallengeWinCount"))
        {
            int currentCount = PlayerPrefs.GetInt("PuzzleChallengeWinCount");
            PlayerPrefs.SetInt("PuzzleChallengeWinCount", currentCount++);
            PlayerPrefs.Save();
        }
        else
        {
            PlayerPrefs.SetInt("PuzzleChallengeWinCount", 1);
            PlayerPrefs.Save();
        }
    }
}
